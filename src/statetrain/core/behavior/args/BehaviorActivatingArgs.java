...
public class BehaviorActivatingArgs<TTrigger, TState> {
    ...
    public BehaviorActivatingArgs(TTrigger trigger, TransitionArgs<TTrigger, TState> transitionArgs, State<TTrigger, TState> attachedState, StateMachineContext<TTrigger, TState> context) {
