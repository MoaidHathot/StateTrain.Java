...
public class BehaviorActivatedArgs<TTrigger, TState> {
    ...
    public BehaviorActivatedArgs(TTrigger trigger, TransitionArgs<TTrigger, TState> transitionArgs, State<TTrigger, TState> attachedState, StateMachineContext<TTrigger, TState> context) {
