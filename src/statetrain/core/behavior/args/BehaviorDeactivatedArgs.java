...
public class BehaviorDeactivatedArgs<TTrigger, TState> {
    ...
    public BehaviorDeactivatedArgs(TTrigger trigger, TransitionArgs<TTrigger, TState> transitionArgs, State<TTrigger, TState> attachedState, State<TTrigger, TState> newState, StateMachineContext<TTrigger, TState> context) {
    ...
    public String toString() {
        return "BehaviorDeactivatedArgs{" +
                "trigger=" + trigger +
